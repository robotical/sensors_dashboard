...
import Graph from "../GraphClassification";
import GraphControls from "../GraphControls";
import styles from "../GraphArea/styles.module.css";
import { CSVLink } from "react-csv";

interface GraphAreaClassificationProps {
  graphId: string;
...
export default function GraphAreaClassification({ graphId, removeGraph }: GraphAreaClassificationProps) {
